...
module.exports = async function handler(req, res) {
  ...
  const html = `
    ...
    <p style="margin:0 0 24px;font-size:14px;color:#8b95a5;">Your ZEN ASSETS client account is active. Wallet balance starts at $0 until a deposit is credited.</p>
    ...
    <tr>
      <td style="padding:20px;background:rgba(212,165,116,0.06);border-radius:10px;border:1px solid rgba(212,165,116,0.12);">
        ...
        <tr>
          <td style="padding-bottom:12px;">
            <span style="font-size:11px;color:#8b95a5;text-transform:uppercase;letter-spacing:1px;">Program tier</span><br/>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
      <tr>
        <td style="padding:8px 0;font-size:14px;color:#c8d0dc;line-height:1.6;">
          ...
          <span style="color:#d4a574;font-weight:700;">2.</span>&nbsp; Fund your wallet via deposit instructions in the dashboard.<br/>
